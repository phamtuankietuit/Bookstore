                ...
                obj === null ? (
                    ...
                    <div className={cx('inner')}>
                        <div className={cx('frame')}>
                            <p className={` mb-5 ${cx('title')}`}>Thông tin nhà cung cấp</p>
                            < div >
                                <Row>
                                    <Col lg={8}>
                        ...
                        <div className={cx('frame')}>
                            <div className='d-flex align-items-center mb-3'>
                                <p className={`w-50 ${cx('title')}`}>Đơn nhập hàng thanh toán một phần</p>
                                <div className='text-end w-50'>
                                    <Button className={`m-1 ${cx('my-btn')}`} variant="primary" onClick={handleShowpaid}>Thanh toán</Button>
                                </div>
                            ...
                            <Row className={`w-100 ${cx('bg')} p-3`}>
                                <Col lg={4} className='d-flex mb-1'>
                                    Tiền cần trả nhà cung cấp : <span className='fw-bold ms-1'> {addCommas(obj.total)}</span>
                                </Col>
                                <Col lg={4} className='mb-1'>
                                    Đã trả : <span className='fw-bold ms-1'> {addCommas(obj.paid)}</span>
                                </Col>
                                <Col lg={4} className='mb-1'>
                        ...
                        <div className={cx('frame')}>
                            <p className={` mb-5 ${cx('title')}`}>Thông tin sản phẩm</p>

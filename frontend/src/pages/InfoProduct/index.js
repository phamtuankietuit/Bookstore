                    ...
                    <Row className="w-100 mb-3">
                                ...
                                <Row>
                                    <Col lg={5}>
                                        ...
                                        <div className="d-flex justify-content-center">
                                            <img
                                                src="https://bizweb.dktcdn.net/100/319/535/files/screenshot-3-03c05975-1f8e-463e-aec6-9eb87890bd48.png?v=1569317007339"
                                    ...
                                    <Col lg={7}>
                                        <p className={`w-100 ${cx('name')}`}>
                                            Bút lông bi cao cấp Parker IM
                                            X-Black CT TB4-1975575
                                        </p>
                                        <p>Đã bán 9</p>
                        ...
                        <Col lg={4}>
                            <div className={` ${cx('frame')} h-100`}>
                                ...
                                <div>
                                    <p className="mb-3">
                                        Là đối tác lý tưởng với tiềm năng vô
                                        hạn, sở hữu thiết kế hiện đại, Parker IM
                                        khơi nguồn cảm hứng sáng tạo cho những
                                        người đang tìm kiếm ý tưởng mới trên con
                                        đường khởi nghiệp. Với ngòi thép không
                                        gỉ và hoàn thiện theo di sản Parker, mỗi
                                        chi tiết được tinh chế để đem đến trải
                                        nghiệm viết đáng tin cậy.
                                    </p>
